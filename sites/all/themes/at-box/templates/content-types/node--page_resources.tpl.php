...
$tco_calculator = $wrapper->field_tco_calculator->value();
$tco_calculator_image = $wrapper->field_tco_calculator_image->value();
$tco_calculator_image_mobile = $wrapper->field_tco_calculator_img_mobile->value();
?>
      ...
      <div class="shadow-top line-no-shadow"> 
        <div class="block-calculator">
          <div class="tco-calculator">
            <?php !empty($tco_calculator['value']) && print $tco_calculator['value'];?>
          </div>
          <div class="block-photo">
              <img src="<?php echo file_create_url($tco_calculator_image['uri']); ?>" alt="calculator" class="img-destop"/>
              <img src="<?php echo file_create_url($tco_calculator_image_mobile['uri']); ?>" alt="calculator" class="img-720"/>
          </div>
        </div>
      </div>
    </div>
    <?php
      $block = module_invoke('be', 'block_view', 'resources');
