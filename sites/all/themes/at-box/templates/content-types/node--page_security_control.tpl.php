 ...
 * Reviewed by Victor Reyes Heitmann, Technical Architect, Pyramid Consulting May 21 2013
...
<div id="main-content" class="clearfix">
  <?php 
    if ($wrapper->field_security_control_desc->count()) {
      foreach ($wrapper->field_security_control_desc as $field_desc) {
        $description = $field_desc->value();
        !empty($description['value']) && print $description['value'];
      }
    }
  ?>
