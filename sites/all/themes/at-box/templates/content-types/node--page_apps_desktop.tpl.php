...
$browse_apps = $wrapper->field_apps_more_block->value();
$desktop_block_desc = $wrapper->field_apps_desktop_block->value();
$mobile_block_desc = $wrapper->field_apps_mobile_block->value();
  ...
  <div class="clearfix page_u6 line-no-shadow">
    <?php 
      print theme('box_apps_devices', array(
        'curr_device' => $device, 
        'device' => '320', 
        'title' => $desktop_block_desc['value'], 
        'node_language' => $node->language,
        'apps' => $wrapper->field_apps_desktop_apps
      )); 
    ?>
    <?php 
      print theme('box_apps_devices', array(
    ...
    <?php 
      print theme('box_apps_devices', array(
        'curr_device' => $device, 
        'device' => '978', 
        'title' => $mobile_block_desc['value'], 
        'node_language' => $node->language,
        'apps' => $wrapper->field_apps_mobile_apps,
        'mobile_apps_in_desk' => TRUE
      )); 
    ?>
    ...
    <div class="content panel-browse-app bg-gray v978">
      <?php 
      print theme('more_apps_devices', array(
        'curr_group'    => array('desktop', 'tablet', 'mobile'),
        'device'        => 'desktop',
        'title'         => $more_apps_title['value'],
        'node_language' => $node->language,
        'apps' => $wrapper->field_apps_more_apps,
