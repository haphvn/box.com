...
$resource_category = $wrapper->field_resource_category->value();
?>
<div id="banner" class="clearfix">
  <?php echo theme('hero_banner', array('hero_banner' => $wrapper->field_hero_banner, 'custom_class' => 'main-banner banner_white_paper'))?>
</div>
<div id="main-content" class="clearfix">
  <div class="clearfix page_t8_wp line-no-shadow">
    <h3><?php echo $title?></h3>
    <div class="content bg-gray white_paper clearfix v720">
      <div class="shadow-top">
      <?php print views_embed_view('resources', 'block_resource', $resource_category->tid); ?>
      </div><!-- end .shadow-top -->
    </div><!-- end .white_paper -->
  </div><!-- end .page_t8_wp -->
