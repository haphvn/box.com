...
<div id="main-content" class="clearfix">
  ...
  <?php 
    if ($wrapper->field_partners->count()) {
      foreach ($wrapper->field_partners as $field_partners) { 
        $partner = $field_partners->field_partners_description->value();
        !empty($partner['value']) && print $partner['value'];
      }
    }
  ?>
  </div><!-- end .clearfix -->
