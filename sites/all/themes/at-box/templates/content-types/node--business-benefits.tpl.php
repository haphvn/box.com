...
<div id="banner" class="clearfix">
  <?php echo theme('hero_banner', array('hero_banner' => $wrapper->field_hero_banner, 'custom_class' => 'main-banner'))?>
</div>
<div id="subNavi">
  <div class="sub-menu">
    <ul>
      <?php foreach ($wrapper->field_content as $i): ?>
      <?php $ftitle = $i->field_title->value();
      		$ftitle_anchor = strtolower(strip_tags(str_replace(' ', '_', $ftitle)))?>
      <?php $fclass = $i->field_class->value();?>
      <li>
        <a href="#<?php echo $ftitle_anchor?>"><p class="<?php echo $fclass ?>"><span><?php echo $ftitle ?></span></p></a>
      </li>
      <?php endforeach; ?>
    </ul>
  </div>
...
<div id="main-content">
  <div class="clearfix">
    <?php foreach ($wrapper->field_content as $i): ?>
    <?php $fcontent = $i->field_block_content->value();?>
    <?php echo isset($fcontent['value']) ? $fcontent['value'] : '' ?>
    <?php endforeach; ?>
  </div>
</div>