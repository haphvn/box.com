...
0. Dowload bookreader from https://github.com/shenzhuxi/bookreader and put BookReader directory to $YOUR_DRUPAL/sites/all/libraries. Go to https://github.com/openlibrary/bookreader/pull/7 to ask openlibrary pull my fix into the master. 
